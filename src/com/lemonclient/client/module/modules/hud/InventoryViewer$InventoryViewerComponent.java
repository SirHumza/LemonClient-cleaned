...
private class InventoryViewer.InventoryViewerComponent
extends HUDComponent {
    public InventoryViewer.InventoryViewerComponent(ITheme theme) {
    ...
    public void render(Context context) {
        ...
        GSColor bgcolor = new GSColor(InventoryViewer.this.fillColor.getValue(), (Integer)InventoryViewer.this.fill.getValue());
        context.getInterface().fillRect(context.getRect(), bgcolor, bgcolor, bgcolor, bgcolor);
        GSColor color = new GSColor(InventoryViewer.this.outlineColor.getValue(), (Integer)InventoryViewer.this.outline.getValue());
