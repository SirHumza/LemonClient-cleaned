...
extends Module {
    ...
    private void windowClick(int slot, int to) {
        AutoEChest.mc.field_71439_g.field_71174_a.func_147297_a((Packet)new CPacketClickWindow(AutoEChest.mc.field_71439_g.field_71069_bz.field_75152_c, slot, to, ClickType.SWAP, ItemStack.field_190927_a, AutoEChest.mc.field_71439_g.field_71070_bA.func_75136_a(AutoEChest.mc.field_71439_g.field_71071_by)));
        if (((Boolean)this.update.getValue()).booleanValue()) {
            AutoEChest.mc.field_71442_b.func_78765_e();
        }
    }

    @Override
    public void onUpdate() {
        if (AutoEChest.mc.field_71441_e == null || AutoEChest.mc.field_71439_g == null || AutoEChest.mc.field_71439_g.field_70128_L) {
            return;
        }
        ...
        ItemStack stack = (ItemStack)AutoEChest.mc.field_71439_g.field_71071_by.field_70462_a.get(slot);
