...
extends Notification {
    ...
    public void render(int RealDisplayWidth, int RealDisplayHeight) {
        Color color2;
        boolean customFont = (Boolean)ColorMain.INSTANCE.customFont.getValue();
        ...
        Gui.func_73734_a((int)(RealDisplayWidth - offset), (int)(RealDisplayHeight - 5 - height), (int)RealDisplayWidth, (int)(RealDisplayHeight - 5), (int)color.getRGB());
        Gui.func_73734_a((int)(RealDisplayWidth - offset), (int)(RealDisplayHeight - 5 - height), (int)(RealDisplayWidth - offset + 4), (int)(RealDisplayHeight - 5), (int)color2.getRGB());
