...
public class Notifications {
    ...
    public Notifications(String message, Type type) {
        ...
        this.timer.reset();
        this.width = Minecraft.func_71410_x().field_71466_p.func_78256_a(message) + 35;
        this.height = 20.0;
        this.animationX = this.width;
        this.stayTime = 1000L;
        this.posY = -1.0;
        this.t = type;
        if (type.equals((Object)Type.INFO)) {
            this.color = -14342875;
        } else if (type.equals((Object)Type.ERROR)) {
            this.color = new Color(36, 36, 36).getRGB();
        } else if (type.equals((Object)Type.SUCCESS)) {
            this.color = new Color(36, 36, 36).getRGB();
        } else if (type.equals((Object)Type.DISABLE)) {
            this.color = new Color(36, 36, 36).getRGB();
        } else if (type.equals((Object)Type.WARNING)) {
            this.color = -14342875;
        }
    }
    ...
    public void draw(double getY, double lastY) {
        this.width = Minecraft.func_71410_x().field_71466_p.func_78256_a(this.message) + 25;
        this.height = 22.0;
        this.lastY = lastY;
        this.animationX = this.getAnimationState(this.animationX, this.isFinished() ? this.width : 0.0, 450.0);
        this.posY = this.posY == -1.0 ? getY : this.getAnimationState(this.posY, getY, 350.0);
        ScaledResolution res = new ScaledResolution(Minecraft.func_71410_x());
        int x1 = (int)((double)res.func_78326_a() - this.width + this.animationX / 2.0);
        int x2 = (int)((double)res.func_78326_a() + this.animationX / 2.0);
        int y1 = (int)this.posY - 22;
        int y2 = (int)((double)y1 + this.height);
        RenderUtil.drawRect(x1, y1, x2, y2, Notifications.reAlpha(this.color, 0.85f));
        RenderUtil.drawRect(x1, y2 - 1, (long)x1 + Math.min((long)(x2 - x1) * (System.currentTimeMillis() - this.timer.getPassedTimeMs()) / this.stayTime, (long)(x2 - x1)), y2, Notifications.reAlpha(-1, 0.85f));
        switch (this.t) {
            case ERROR: {
        ...
        if (this.message.contains(" Enabled")) {
            Minecraft.func_71410_x().field_71466_p.func_78276_b(this.message, x1 + 19, (int)((double)y1 + this.height / 4.0), -1);
            Minecraft.func_71410_x().field_71466_p.func_78276_b(" Enabled", x1 + 20 + Minecraft.func_71410_x().field_71466_p.func_78256_a(this.message), (int)((double)y1 + this.height / 4.0), -9868951);
        } else if (this.message.contains(" Disabled")) {
            Minecraft.func_71410_x().field_71466_p.func_78276_b(this.message, x1 + 19, (int)((double)y1 + this.height / 4.0), -1);
            Minecraft.func_71410_x().field_71466_p.func_78276_b(" Disabled", x1 + 20 + Minecraft.func_71410_x().field_71466_p.func_78256_a(this.message), (int)((double)y1 + this.height / 4.0), -9868951);
        } else {
            Minecraft.func_71410_x().field_71466_p.func_78276_b(this.message, x1 + 20, (int)((double)y1 + this.height / 4.0), -1);
        }
    }
