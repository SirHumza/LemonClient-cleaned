...
public class MotionUpdateEvents
extends LemonClientEvent {
    ...
    extends MotionUpdateEvents {
        ...
        public Riding(double x, double y, double z, float rotationYaw, float rotationPitch, boolean onGround, float moveStrafing, float moveForward, boolean jump, boolean sneak) {
