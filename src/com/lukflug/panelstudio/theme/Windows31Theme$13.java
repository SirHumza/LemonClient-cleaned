...
implements ISwitchRenderer<String> {
    ...
    Windows31Theme.13(boolean bl, int n, int n2) {
    ...
    public void renderButton(Context context, String title, boolean focus, String state) {
        ...
        Color textColor = this.val$container && effFocus ? Windows31Theme.this.getMainColor(effFocus, false) : Windows31Theme.this.getFontColor(effFocus);
        ...
        Windows31Theme.this.getSmallButtonRenderer(5, this.val$logicalLevel, this.val$graphicalLevel, this.val$container).renderButton(subContext, null, effFocus, null);
        rect = this.getOffField(context);
        subContext = new Context(context, rect.width, new Point(rect.x - context.getPos().x, 0), true, true);
        subContext.setHeight(rect.height);
        Windows31Theme.this.getSmallButtonRenderer(4, this.val$logicalLevel, this.val$graphicalLevel, false).renderButton(subContext, null, effFocus, null);
    }
