...
extends Button<Void> {
    ...
    Spinner.5(ILabeled x0, Supplier x1, IButtonRenderer x2, INumberSetting iNumberSetting, TextField textField) {
    ...
    public void handleButton(Context context, int button) {
        ...
        if (button == 0 && context.isClicked(button)) {
            ...
            if ((number += Math.pow(10.0, -this.val$setting.getPrecision())) <= this.val$setting.getMaximumValue()) {
