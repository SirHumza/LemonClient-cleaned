...
class SearchableLayout.4
extends ScrollBarComponent<Void, IComponent> {
    SearchableLayout.4(IComponent x0, IScrollBarRenderer x1, IEmptySpaceRenderer x2, IEmptySpaceRenderer x3) {
        super(x0, x1, x2, x3);
    }
